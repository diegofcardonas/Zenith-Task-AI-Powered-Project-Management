        ...
        <header className="flex-shrink-0 flex items-center justify-between p-3 sm:p-4 border-b border-border bg-surface/80 backdrop-blur-md sticky top-0 z-40">
            ...
            <div className="flex items-center space-x-1 sm:space-x-3 flex-shrink-0">
                ...
                <button 
                    ...
                    className="p-2 rounded-full hover:bg-secondary-focus text-text-secondary hover:text-text-primary transition-colors hidden sm:block"
                        ...
                        {isUserMenuOpen && (
                            <div className="absolute top-full right-0 mt-2 w-72 bg-[#1e293b] rounded-xl shadow-2xl border border-white/10 z-50 animate-scaleIn origin-top-right overflow-hidden backdrop-blur-xl">
                                ...
                                <div className="p-2 space-y-1">
                                    ...
                                    {/* Mobile Help Link inside menu */}
                                    <button 
                                        onClick={() => { setIsHelpOpen(true); setIsUserMenuOpen(false); }}
                                        className="w-full text-left px-3 py-2.5 rounded-lg hover:bg-white/5 flex items-center gap-3 text-sm text-text-secondary hover:text-white transition-colors group sm:hidden"
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-text-secondary group-hover:text-primary transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                                        {t('header.help')}
                                    </button>
